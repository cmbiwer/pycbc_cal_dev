...
setup (
    ...
    scripts  = [
               ...
               'bin/sngl/pycbc_export_censored_trigs',
               'bin/sngl/pycbc_nagios_daily_monitor',
               'bin/sngl/run_daily_pycbc_export_censored_trigs',
               'bin/sngl/run_daily_pycbc_make_coinc_search_workflow',
